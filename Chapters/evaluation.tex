...
The G12/FD runs using predecessor filter with version 1.6, using predecessor filter with version 1.6 and using predecessor filter with version 2.0.1 all find solutions, although none of them are the optimal.
