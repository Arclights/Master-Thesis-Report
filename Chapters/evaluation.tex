...
The time for the assembly reached by the solvers as the optimal was ??. This the time we will use as the optimal when we further down talk about which solvers reached the optimal but did not finish the search.
