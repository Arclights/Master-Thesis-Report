...
\noindent We group together all tasks in one set in order for a more readable notation further down.
 ...
 \begin{figure}
 \include{Figures/taskSubComponents}
 ...
 \end{equation}
  ...
  \begin{figure}
  \include{Figures/taskCompleteSubComponents}
...
\\\\
 ...
 \end{equation}
  ...
  \\
  Please note that there is a bug in the reasoning of $k$. We will discuss it further in section \ref{sec:discuss_bug}.
