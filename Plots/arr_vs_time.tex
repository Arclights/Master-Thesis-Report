\begin{tikzpicture}
\begin{semilogyaxis}[xlabel=\# Arrays, ylabel=Time (ms), 	scatter/classes={%
		j1={mark=+,blue},%
		j2={mark=x,blue},%
...
\addplot+[scatter, scatter src=explicit symbolic, only marks] table[ x=int,y=time, meta=label] {Plots/arr_vs_time.dat};
